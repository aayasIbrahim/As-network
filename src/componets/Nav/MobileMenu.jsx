...
function MobileMenu({ scrolled}) {
  return (
    <>
    <div className= {`absolute w-full h-[300px] top-[55px] right-0  p-4 rounded shadow-2xl font-bold  ${scrolled ? "bg-white text-black ":"bg-[#001f4d]/[50] text-white"} md:hidden  z-50 top-0 pt-0 lg:pb-1.5 md:pb-1.5 pb-0 lg:rounded-none md:rounded-none rounded-b-xl lg:border-none md:border-none border-b border-gray-700 lg:bg-[#00204f57] md:bg-[#00204f57] bg-[#00204fc1] dark:lg:bg-[#00204f57] dark:md:bg-[#00204f57] dark:bg-[#00204fc1]`}>
             ...
             <a href="/" className="whitespace-nowrap text-base font-medium text-blue-400 dark:text-blue-500 hover:text-blue-500 flex items-center justify-center gap-2 mt-4">
                    <span className={`text-base font-medium ${scrolled ? "text-black":"text-gray-200"}`}>Do you need help?</span>
                    Contact
                   </a>
             </div>
            </div>
