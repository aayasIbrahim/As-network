...
function MobileMenu() {
  return (
    <>
    <div className='absolute w-full h-[300px] top-[55px] right-0 text-white p-4 rounded shadow-2xl bg-[#001f4d]/[50] md:hidden'>
                <ul className='flex   justify-center  items-center  space-x-[50px] text-center text-xl font-bold'>
                  <div className='space-y-5 text-base font-medium text-gray-200 '>
